...
from gazemotion.gaze.training import TargetSamples, robust_sample_subset, select_best_profile
    ...
    for index, target in enumerate(targets, start=1):
        ...
        if len(selected) < minimum_samples:
            ...
            raise RuntimeError(
                ...
                f"{reason} Move closer, improve front lighting, and run `gazemotion test`."
            )
